...
#metodo GET, porque ele esta fazendo um pedido
def executar_api():
...
def main():
    ...
    #precisamos interpretar o json, assim definindo a estrutura do laco de repetição.
    #Assim podemos encontrar o dado para o tratamento
    try:
        retornoJSON = executar_api()
        for item in retornoJSON:
            #Aqui encontro o municipio
